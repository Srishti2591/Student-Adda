...
<html>
<head>
<title> SignUp - student adda</title>
...
?>
      ...
      <?php if(isset($done)) 
      { ?>
    <div class="successmsg"><span style="font-size:100px;">&#9989;</span> <br> You have registered successfully . <br> <a href="login10.php" style="color:#fff;">Login here... </a> </div>
      <?php } else { ?>
...
<div class="form-group">
  ...
  <button type="submit" name="signup" class="btn btn-primary btn-group-lg form_btn">SignUp</button>
   <p>Have an account?  <a href="login10.php">Log in</a> </p>
</form>
<?php } ?> 
</div>
		</div>
