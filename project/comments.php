...
if (isset($_GET['page_id'])) {
    ...
    if (isset($_POST['name'], $_POST['content'])) {
        ...
        exit('Your problems/solutions has been submitted!');
    }
...
<html>
    ...
    <span class="total"><?=$comments_info['total_comments']?> discussions</span>
    <a href="#" class="write_comment_btn" data-comment-id="-1">Write your problem</a>
</div>
